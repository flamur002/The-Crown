...
<head>
  ...
  <title>Customer - The Crown</title>
</head>
...
<div class="h-screen flex flex-row flex-wrap">
  ...
  <div id="sideBar" class="relative flex flex-col flex-wrap bg-white border-r border-gray-300 p-6 flex-none w-64 md:-ml-64 md:fixed md:top-0 md:z-30 md:h-screen md:shadow-xl animated faster">
    ...
    <div class="flex flex-col">
      ...
      <!-- link -->
      <a href="/customer" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
      ...
      <p class="uppercase text-xs text-gray-600 mb-4 mt-4 tracking-wider"></p>
        ...
        <!-- link -->
        <a href="/mybookings" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
        ...
        <!-- link -->
        <a href="/mybookings/cancelled" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
            <i class="fad fa-calendar-edit text-xs mr-2"></i>
            Canelled Bookings
        </a>
        <!-- end link -->
