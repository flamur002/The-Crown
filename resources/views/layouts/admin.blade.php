...
<div class="h-screen flex flex-row flex-wrap">
  ...
  <div id="sideBar" class="relative flex flex-col flex-wrap bg-white border-r border-gray-300 p-6 flex-none w-64 md:-ml-64 md:fixed md:top-0 md:z-30 md:h-screen md:shadow-xl animated faster">
    ...
    <!-- link -->
        ...
        <i class="fa-sharp fa-solid fa-bed fa-sm"></i> &nbsp; 
            Rooms
        </a>
    <!-- end link -->   
      ...
      <p class="uppercase text-xs text-gray-600 mb-4 mt-4 tracking-wider">Accounts</p>

      <!-- link -->
      <a href="/admin/admins" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
      ...
      <!-- link -->
      <a href="/admin/staff" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
        <i class="fa-solid fa-user-group"></i>
        &nbsp Staff Members
      </a>
      <!-- end link -->
      ...
      <!-- link -->
      <a href="/admin/customers" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
        <i class="fa-solid fa-user-group"></i>
        &nbsp Customers
      </a>
      <!-- end link -->  
